...
- [Getting\_Started\_With\_FastAPI](#getting_started_with_fastapi)
  ...
  - [웹 Web](#웹-web)
    ...
    - [웹 기술 아이디어](#웹-기술-아이디어)
    - [12요소 애플리케이션(Twelve-Factor App)](#12요소-애플리케이션twelve-factor-app)
  - [의존성](#의존성)
    - [의존성 관련 문제](#의존성-관련-문제)
    - [의존성 주입 방법](#의존성-주입-방법)
  - [인사이트](#인사이트)
...
- 싱글톤은 디자인 패턴 중 하나로 여러 차례 호출되어도 최소 실행시에만 객체가 생성되고, 그 뒤로는 이전에 생성된 객체를 반환하는 것.
- 이 방법으로 반복된 코드에도 메모리 공간이 절약된다.
...
### 12요소 애플리케이션(Twelve-Factor App)

> 소프트웨어 애플리케이션을 구축하는 방법론
